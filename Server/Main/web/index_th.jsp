...
<div id="fullpage">
        ...
        <div align="center" class="intro">
            ...
            <table style="margin-top: 100px">
                <tr>
                    ...
                    <td>
                        <h1>สถานที่ตั้งสำหรับนักท่องเที่ยวชาวต่างชาติ<br>
                            บริการข้อมูลการท่องเที่ยว Dawent</h1>
                        <br>
                        <h3>*บริการ Dawent คืออะไร<br>Docent เป็นบุคคลที่อธิบายถึงนิทรรศการ<br>ดอว์สันมีโอกาสที่จะ<br>คำอธิบายโดยละเอียดช่วยให้ผู้เข้าชมเข้าใจนิทรรศการ </h3>
                    </td>
                </tr>
        ...
        <div align="center" class="intro">
            ...
            <table style="margin-top: 100px">
                <tr>
                    ...
                    <td style="width: 100px"></td>
                    <td>
                        <h1>ใช้ประโยชน์ API ข้อมูลสาธารณะ<br>
                            ให้ข้อมูลการท่องเที่ยวที่หลากหลาย</h1>
                        <br>
                        <h3>ใช้ Tour API 3.0 ที่จัดทำโดยองค์การการท่องเที่ยวเกาหลี<br>ให้ข้อมูลการท่องเที่ยวที่มีคุณภาพหลากหล<br>ายเช่นสถานที่ท่องเที่ยวในประเทศเทศกาลและอาหาร</h3>
                    </td>
                </tr>
        ...
        <div align="center" class="intro">
            ...
            <table style="margin-top: 100px">
                <tr>
                    ...
                    <td style="width: 100px"></td>
                    <td>
                        <h2>รองรับภาษาต่าง ๆ 12 แบบและ<br>
                            ใช้ Google TTS API<br>ให้บริการ Docent</h2>
                        <br>
                        <h4>รองรับ 12 ภาษาทำให้ง่ายสำหรับนักท่องเที่ยวจากหลายประเทศ<br>
                            ใช้ประโยชน์จาก Google Text-To-Speech API เพื่อแปลงคำพูดเป็นภาษาต่างๆ
                            <br>ความสำเร็จด้านการวิจัยของ WaveNet <br>ด้วยการใช้เครือข่ายประสาทที่ทรงพลังของ<br> Google เพื่อมอบคุณภาพเสียงที่ดีที่สุด<br>
                            บริการเอกสารคุณภาพดีสำหรับนักท่องเที่ยว</h4>
                    </td>
                </tr>
        ...
        <div align="center" class="intro">
            ...
            <table style="margin-top: 100px">
                <tr>
                    ...
                    <td style="width: 100px"></td>
                    <td>
                        <h2>สำหรับข้อมูลการท่องเที่ยวที่หลากหลาย<br>
                            บริการการนำทางตามตำแหน่ง</h2>
                        <br>
                        <h4>คุณสามารถใช้ Kakao API เพื่อเรียนรู้เกี่ยวกับข้อมูลต่าง <br>ๆ เช่นแหล่งท่องเที่ยวอาหารเทศกาล ฯลฯ<br>เราสนับสนุนบริการเส้นทางตามสถานที่ตั้งของคุณ </h4>
                    </td>
                </tr>
        ...
        <div align="center" class="intro">
            ...
            <table style="margin-top: 100px">
                <tr>
                    ...
                    <td style="width: 100px"></td>
                    <td>
                        <h1>สำหรับข้อมูลการท่องเที่ยวที่ฉันต้องการ<br>
                            บริการนึ่ง (รายการโปรด)</h1>
                        <br>
                        <h3>ระบุรายการสินค้าที่ต้องการ (รายการโปรด) <br>เพื่อค้นหาว่าผู้ใช้ต้องการไปที่ไหน<br>ประหยัดความสะดวกสบาย</h3>
                    </td>
                </tr>
    ...
    <div class="section" id="section3">
        <div class="mask flex-center rgba-black-strong">
            <h5>เราจะนำคุณไปสู่โลกแห่งวัฒนธรรมและเทศกาลของเกาหลี<br>ดาวน์โหลดตอนนี้<br><br>
                <i class="fab fa-android fa-3x" onclick="alert('ในการเตรียมการ')" style="cursor: pointer">&nbsp</i>
                <i class="fab fa-apple fa-3x" onclick="alert('ในการเตรียมการ')" style="cursor: pointer">&nbsp</i>
                <i class="fab fa-windows fa-3x" onclick="alert('ในการเตรียมการ')" style="cursor: pointer"></i>
            </h5>
            <br>
