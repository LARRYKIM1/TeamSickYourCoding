...
public class TravelDao {
    ...
    public TravelVO getByConid(String id, String lang){
        ...
        try{
            conn = connect();
             if(conn!=null){ pstmt = conn.prepareStatement("SELECT * FROM tour_tbl WHERE contentid = ?");
    ...
    public ArrayList<TravelVO> getByConTypeid(String id, String num){
        ...
        try{
            conn = connect();
            if(conn!=null){ pstmt = conn.prepareStatement("SELECT * FROM tour_tbl WHERE contenttypeid = ? LIMIT ?,10");
                pstmt.setString(1, id);
    ...
    public ArrayList<AreaVO> getByAreaCode(String id, String area, String sigun, String num, String lang){
        ...
        try{
            conn = connect();
            if(conn!=null){pstmt = conn.prepareStatement("SELECT * FROM tour_tbl WHERE areacode = ? AND sigungucode = ? AND contenttypeid = ? LIMIT ?,10");
    ...
    public ArrayList<AreaVO> getByAreaAll(String id, String area, String num, String lang){
        ...
        try{
            conn = connect();
            if(conn!=null){ pstmt = conn.prepareStatement("SELECT * FROM tour_tbl WHERE areacode = ? AND contenttypeid = ? LIMIT ?,10");
                pstmt.setString(1, area);
